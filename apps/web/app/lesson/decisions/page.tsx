...
export default function DecisionsLessonPage() {
  const chapter = getChapterBySlug("decisions")!;
      ...
      <div className="page-frame">
        ...
        <article className="lesson-content">
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-surface-border pb-4">
            <p className="eyebrow">QUEST 02 · {chapter.title.toUpperCase()}</p>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-between gap-4 border-t border-surface-border pt-6">
            <Link href="/lesson/variables" className="secondary-button px-5 py-3 font-bold text-sm">
              ← Chapter 1
            </Link>
            <Link
              href={complete ? "/quiz/decisions" : "#"}
